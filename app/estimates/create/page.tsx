...
export default function CreateEstimate() {
    ...
    const handleSubmit = async () => {
        if (orderValidation(estimate) === true) {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/estimates/insertOne`, {
                method: "POST",
                headers: {
            ...
            router.push(`/estimates/print/${result?._id}`);
        }
    };
        ...
        <Appshell>
            <div className="flex align-middle justify-between">
                ...
                <div className="flex gap-3 mb-4">
                    <SellerSelectorPopup isDefaultOpen={true} order={estimate} handleChange={handleChange} />
                    {/* <Button
                        className={
            ...
            <div className="flex flex-col gap-1 text-sm font-semibold py-4">
                <div className="flex gap-8">
                    ...
                    {/* <div className="flex flex-col">
                        ...
                        <OrderDatePicker order={estimate} handleChange={handleChange} />
                    </div> */}
                </div>
