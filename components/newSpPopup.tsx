...
export function NewSpPopup({ handleChange, order }: { handleChange: any; order: any }) {
    ...
    const createPlateau = () => {
        ...
        order.specialMeals.push(finalPlateau);
    ...
    return (
        <AlertDialog open={isPopupOpen}>
            <Button onClick={() => setPopupOpen(true)} variant="outline">
                Créer un plateau spécial
            </Button>
            <AlertDialogContent className="max-w-[40rem]">
                <AlertDialogHeader>
                    <AlertDialogTitle className="flex justify-between">
                        <span>Nouveau plateau spécial</span>
