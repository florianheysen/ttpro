        ...
        <div className="mt-5 h-0 flex-1 overflow-y-auto">
          <nav className="space-y-1 px-2">
            ...
            <a href="#" className="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
              ...
              --> */}
              <svg className="text-gray-500 mr-4 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <a href="#" className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
              <svg className="text-gray-400 group-hover:text-gray-500 mr-4 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    ...
    <div className="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-5">
      <div className="flex width-full justify-between items-center px-4">
        <ContextMenu>
          ...
          <ContextMenuContent>
            ...
            <ContextMenuItem>Page d&apos;arrivée</ContextMenuItem>
          </ContextMenuContent>
        </ContextMenu>
        <ClerkLoading>
        ...
        <ClerkLoaded>
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 ml-48 mt-1">
              ...
              <DropdownMenuLabel className="text-xs font-normal opacity-70 -mt-3">{user?.primaryEmailAddress?.emailAddress}</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuGroup>
      ...
      <div className="mt-5 flex flex-grow flex-col">
        <nav className="flex-1 space-y-1 px-2 pb-4">
          {
            mainPages.map(page => 
              <Button key={page.href} className="w-full justify-start" variant={page.current ? 'default' : 'ghost'} asChild>
                <Link href={page.href}>{page.icon} {page.name}</Link>
              </Button>
            )
          }
        </nav>
